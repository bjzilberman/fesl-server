...
var insertLog = function(uid, pid, ip, username, log_type, cb) {
    GsUtil.dbConnection(db_log, (err, connection) => {
        ...
        connection.query('INSERT INTO revive_logs_prod.logs_gamespy_auth (uid, pid, ip, username, log_type, shard) VALUES (?, ?, INET_ATON(?), ?, ?, ?)', [uid, pid, ip, username, log_type, shardname], (err, res) => {
