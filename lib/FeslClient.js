...
function FeslClient(name, clientSocket) {
    ...
    this.socket.on('data', function(data) {
        ...
        console.log(payloadId.toString(16));
        ...
        _this.emit(payloadType + '.' + payload['TXN'], payload);
    })
    ...
    this.write = function(type, payload, type2) {
        if (this.socketActive) {
            ...
            buff.writeUIntBE(this.counter, 4, 4);
            buff.writeUIntBE(len, 8, 4);
            buff.write(12, payloadEncoded);
